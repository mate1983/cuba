...
package com.haulmont.cuba.web.app.hoverloginwindow;
...
public class HoverAppLoginWindow extends AbstractWindow implements Window.TopLevelWindow {

    private static final Logger log = LoggerFactory.getLogger(AppLoginWindow.class);

    protected static final ThreadLocal<AppLoginWindow.AuthInfo> authInfoThreadLocal = new ThreadLocal<>();
    ...
    protected void initLocales() {
        ...
        localesSelect.addValueChangeListener(e -> {
            ...
            authInfoThreadLocal.set(new AppLoginWindow.AuthInfo(loginField.getValue(), passwordField.getValue(),
    ...
    protected void initDefaultCredentials() {
        AppLoginWindow.AuthInfo authInfo = authInfoThreadLocal.get();
        if (authInfo != null) {
